  ...
  const handleDelete = async (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        await axios.delete(`${process.env.REACT_APP_BASE_URL}/api/blog/${id}`);
  ...
  return (
    <div>
      ...
      <div className="overflow-x-auto">
        <TitleCard
          title="In this space, you have the ability to add, search, update, and delete your blogs with ease."
          topMargin="mt-2"
          TopSideButtons={
            <TopSideButtons
